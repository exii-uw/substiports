...
(function () {
    ...
    // import hull_intersect from './hull_intersect.js';
    // const intersect = hull_intersect.intersect;

    // // const grid = require('./grid.js');
    // import hull_grid from './hull_grid.js';
    // const grid = hull_grid.grid;

    // // const formatUtil = require('./format.js');
    // import hull_format from './hull_format.js';
    // const formatUtil = hull_format.formatUtil;

    // // const convexHull = require('./convex.js');
    // import hull_convex from './hull_convex.js';
    // const convexHull = hull_convex.convexHull;
    ...
    function fromXy(pointset, format) {
        if (format === undefined) {
            return pointset.slice();
        }
        return pointset.map(function(pt) {
